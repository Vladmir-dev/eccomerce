...
const Body = () => {
  ...
  const Collections = [
    {
      url:"https://cdn.shopify.com/s/files/1/0431/6404/1378/products/2015-03-20_Ashley_Look_20_23515_15565_grande.jpg?v=1594445642",
      name:'Camelia Reversible Jacket',
      price:'500.00'
    },
    {
      url:"https://www.seagullbook.com/mm5/graphics/00000001/DRESS%20HIGH%20LOW%20HEM%20WAIST%20ELASTIC%20GREEN-5857_640x960.jpg",
      name:'Camelia Reversible Jacket',
      price:'500.00'
    },
    {
      url:"https://m.media-amazon.com/images/I/61QhUX15j1S._UX569_.jpg",
      name:'Camelia Reversible Jacket',
      price:'500.00'
    },
    {
      url:"https://cdn.shopify.com/s/files/1/0369/7452/6600/products/29_44a7b3c0-f28f-483b-ac55-797ed19b51a8_400x.jpg?v=1651787827",
      name:'Camelia Reversible Jacket',
      price:'500.00'
    },
    {
    ...
    <div className="md:mt-[40px] mt-[10px] items-center justify-center font-[Poppins,Arial,Tahoma,Verdana,sans-serif]">
     ...
     <div className='md:block hidden'>
      ...
      <div className='flex justify-center items-center'>
       <div className='flex flex-wrap md:gap-7 justify-center items-center  w-[70%]'>
        {Collections.map((item, index) => (
          <div key={index}>
            <CollectionCard url={item.url} name={item.name} price={item.price}/>
          </div>
        ))}
       </div> 
      </div>
